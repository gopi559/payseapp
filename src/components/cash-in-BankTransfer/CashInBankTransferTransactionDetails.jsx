      ...
      sections: [
        {
          ...
          rows: [
            ...
            { label: t('transaction_type'), value: details?.txn_type ?? 'BANK_TO_WALLET' },
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm font-medium text-gray-800">{details?.txn_type ?? 'BANK_TO_WALLET'}</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm font-medium text-gray-800">{details?.channel_type ?? 'WEB'}</p>
              </div>
            </div>
          </div>
        </div>
