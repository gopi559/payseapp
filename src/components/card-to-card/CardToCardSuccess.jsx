  ...
  return (
    <PageContainer>
      <SuccessScreen
        ...
        message="Card to card transfer completed successfully."
        onDone={handleDone}
        buttonText="Done"
      />
      ...
      <div className="mt-6 mx-auto max-w-xs">
        <div className="bg-white rounded-lg border border-gray-200 p-4 space-y-3">
          ...
          <div className="flex justify-between items-center">
            <span className="text-sm text-gray-600">From Card</span>
            <span className="text-sm font-medium text-brand-dark">{fromCardName}</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-sm text-gray-600">To Card</span>
            <span className="text-sm font-medium text-brand-dark">{toCardName}</span>
          </div>
        </div>
      </div>
