...
const CardToCardTransactionDetails = () => {
  ...
  const txnDesc = details?.txn_desc ?? details?.txn_short_desc ?? 'Card To Card'
  ...
  return (
    <PageContainer className="bg-white">
      ...
      <div className="px-4 py-6 max-w-2xl mx-auto">
        ...
        {/* To Card Details Section */}
        <div className="bg-white rounded-xl border border-gray-200 p-4 sm:p-6 mb-6">
          <div className="flex items-center gap-2 mb-4">
            <div className="w-6 h-6 bg-brand-secondary rounded flex items-center justify-center">
              <HiOutlineCreditCard className="w-4 h-4 text-white" />
            </div>
            <h3 className="text-lg font-bold text-gray-800">To Card Details</h3>
          </div>
