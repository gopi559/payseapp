...
const MobileScreenContainer = ({ children, header, footer }) => {
  return (
    <div className="w-full h-full min-h-full bg-[#C1DFC4] flex justify-center items-stretch overflow-x-hidden">
      <div className="relative w-full max-w-[390px] h-full min-h-full bg-white overflow-hidden flex flex-col sm:rounded-[24px]">
